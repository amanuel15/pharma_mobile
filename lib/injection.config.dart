...
import 'application/drugs/review/review_form/review_form_bloc.dart' as _i11;
import 'application/drugs/search/search_bloc.dart' as _i12;
import 'application/drugs/search/search_result/search_result_bloc.dart' as _i14;
...
import 'application/util/search_history/search_history_cubit.dart' as _i13;
...
import 'infrastructure/auth/auth_facade.dart' as _i16;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.ReviewFormBloc>(
      () => _i11.ReviewFormBloc(get<_i6.IDrugRepository>()));
  gh.factory<_i12.SearchBloc>(
      () => _i12.SearchBloc(get<_i6.IDrugRepository>()));
  gh.factory<_i13.SearchHistoryCubit>(
      () => _i13.SearchHistoryCubit(get<_i4.IDatabaseFacade>()));
  gh.factory<_i14.SearchResultBloc>(
      () => _i14.SearchResultBloc(get<_i6.IDrugRepository>()));
  gh.lazySingleton<_i15.IAuthFacade>(
      () => _i16.AuthFacade(get<_i3.Dio>(), get<_i4.IDatabaseFacade>()));
