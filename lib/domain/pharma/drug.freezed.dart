    ...
    return _then(_value.copyWith(
      ...
      drugName: drugName == freezed
          ...
          : drugName // ignore: cast_nullable_to_non_nullable
              as String,
      drugDetail: drugDetail == freezed
          ? _value.drugDetail
          : drugDetail // ignore: cast_nullable_to_non_nullable
              as String,
      drugOrigin: drugOrigin == freezed
          ? _value.drugOrigin
          : drugOrigin // ignore: cast_nullable_to_non_nullable
              as String,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Drug &&
            ...
            (identical(other.drugDetail, drugDetail) ||
                const DeepCollectionEquality()
                    .equals(other.drugDetail, drugDetail)) &&
            (identical(other.drugOrigin, drugOrigin) ||
                const DeepCollectionEquality()
                    .equals(other.drugOrigin, drugOrigin)) &&
...
abstract class _Drug extends Drug {
  const factory _Drug(
      {required String id,
      required String pharmacyId,
      required String drugName,
